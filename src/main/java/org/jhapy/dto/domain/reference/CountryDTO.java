...
public class CountryDTO extends BaseEntityUUIDId implements Serializable {
  ...
  @EqualsAndHashCode.Exclude @ToString.Exclude private IntermediateRegionDTO intermediateRegion;
