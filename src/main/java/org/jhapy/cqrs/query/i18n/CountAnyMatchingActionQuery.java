...
public class CountAnyMatchingActionQuery extends AbstractCountAnyMatchingQuery<ActionDTO>
    implements Serializable {
  public CountAnyMatchingActionQuery(String filter, Boolean showInactive) {
